...
////////////////////////////////////////////////////////////////
@implementation MetalImageTexturePVR
{
...
- (BOOL)unpack
{
    ...
    if (formatFlags == kPVRTextureFlag_4 || formatFlags == kPVRTextureFlag_2)
    {
        [_imageData removeAllObjects];
        
        if (formatFlags == kPVRTextureFlag_4)
            self.pixelFormat = MTLPixelFormatPVRTC_RGBA_4BPP;
        else if (formatFlags == kPVRTextureFlag_2)
...
{
    _data = [NSData dataWithContentsOfFile:self.filePathStr];
